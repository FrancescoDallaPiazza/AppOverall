...
**10 schede su 11 sono chiuse.** Stato generato dalle schede: il paragrafo `## Decisione` di ognuna e la fonte, questa tabella e la resa.
...
| [11 · Il livello antincendio e il gruppo di primo soccorso: chi li confronta?](decisioni/11-livelli-emergenza.md) | il **motore**, non lo schema · e va decisa **prima del primo import di attestati di emergenza**, perché nell'intervallo produce conformità apparenti | **aperta** |
